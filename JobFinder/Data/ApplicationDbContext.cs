        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ApplicationUser>(entity =>
            {
                ...
                entity.Property(e => e.Email)
                      .IsRequired()
                      .HasMaxLength(256)
                      .IsUnicode(false);          // emails are ASCII -> varchar(256)

                entity.Property(e => e.PasswordHash)
                      .IsRequired()
                      .HasMaxLength(256)
                      .IsUnicode(false);          // BCrypt/Argon2 output is ASCII

                entity.Property(e => e.Role)
                      .IsRequired()
                      .HasMaxLength(20)
                      .IsUnicode(false)
                      .HasConversion<string>();   // stored as 'Applicant' / 'Employer' / 'Admin'

                // No HasDefaultValue(true) on IsActive: EF treats the CLR default (false)
                // as "unset" and would silently write the store default instead.
